...
| Token | Value | Usage |
| --- | --- | --- |
| `$color-gradient-rose` | `linear-gradient(213.89deg, #ff4c4c 7.75%, #821a67 135.08%)` | Decorative gradients only. |
| `$color-gradient-phoenix` | `linear-gradient(213.98deg, #f6a721 7.74%, #fb5a8b 111.22%)` | Decorative gradients only. |
| `$color-gradient-cactus` | `linear-gradient(215.84deg, #bed42b 24.15%, #167491 143.37%)` | Decorative gradients only. |
| `$color-gradient-tree` | `linear-gradient(213.19deg, #21cc79 26.38%, #167491 113.59%)` | Decorative gradients only. |
| `$color-gradient-ocean` | `linear-gradient(206.67deg, #4786f1 25.46%, #4f0e87 187.1%)` | Decorative gradients only. |
| `$color-gradient-smurf` | `linear-gradient(213.61deg, #00c6d7 26.39%, #4786f1 100%)` | Decorative gradients only. |
| `$color-gradient-grape` | `linear-gradient(214.56deg, #c226fb 0%, #0052cc 174.21%)` | Decorative gradients only. |
| `$color-gradient-fabulous` | `linear-gradient(212.75deg, #fb5a8b 37.1%, #9933cc 171.27%)` | Decorative gradients only. |
| `$color-gradient-street` | `linear-gradient(213.69deg, #6e7b91 25.43%, #233049 147.21%)` | Decorative gradients only. |
| `$color-gradient-universe` | `linear-gradient(213.69deg, #202c44 25.43%, #000000 147.21%)` | Decorative gradients only. |
