...
const BdsToast = class {
    ...
    render() {
        return (h("div", { key: '42298274a40ef9a5ec8776ff6f4de5c711d2adb6', class: {
                toast: true,
                [`toast--${this.variant}`]: true,
                [`toast--action--${this.actionType}`]: true,
                [`show show--${this.position}`]: this.show,
                hide: this.hide,
            } }, this.variant === 'notification' && (h("bds-icon", { key: '35f74077e1b9dcbcbc97f179bab3a07c827ec005', class: "toast__ballon", theme: "solid", name: "blip-chat", size: "brand" })), this.icon && h("bds-icon", { key: 'c5f230a107c2c9d4d194ff08aaa6d47089b38fa8', class: "toast__icon", theme: "outline", size: "medium", name: this.icon }), h("div", { key: 'ba96cfaef77af46ffb7bed76ec2214ca39ed3347', class: "toast__content" }, this.toastTitle && (h("bds-typo", { key: '44173c5a800a60974b6833ffc02db092013adc02', variant: "fs-14", bold: "bold" }, this.toastTitle)), this.toastText && h("bds-typo", { key: 'f7ee659306ad3c751d3eb2dc29b8d1428f6f1d1d', variant: "fs-14", innerHTML: this.toastText })), h("div", { key: '0702f9d8ffd9f94dbc9a59e0d8cde5dc7ef5fbf0', class: {
                toast__action: true,
