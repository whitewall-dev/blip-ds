...
export class Tab {
    ...
    render() {
        ...
        return (h(Host, { key: 'dc097b98f6b25f052df7052483b7db157126f7ba', class: {
                'bds-tab': true,
                ['bds-tab--selected']: this.isActive,
            }, onClick: this.onClick.bind(this) }, h("div", { key: '98503a65a6a9bb53b007cc5d643e293d5bb17cba', class: "bds-tab__text" }, h("bds-typo", { key: '6d01d2fe2b75e903e5d7ae3127a22e5668716eaa', variant: "fs-16", bold: bold }, this.label))));
    }
