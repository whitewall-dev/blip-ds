...
const Input = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '77a1d46c87f2b5174cc1fca2703b08a02c4bbae1', "aria-disabled": this.disabled ? 'true' : null }, index.h("div", { key: '79d3780e63002167c4ee997b0f68ff8060daa89b', class: {
                input: true,
            ...
            }, onClick: this.onClickWrapper, onKeyDown: this.keyPressWrapper, part: "input-container" }, this.renderIcon(), index.h("slot", { key: 'a2c447f1938d60458b3a7190a4b1a21c2c593c90', name: "input-left" }), index.h("div", { key: 'f8a4c4a7460cfa5643a48306f60c3fef414dd429', class: "input__container" }, this.renderLabel(), index.h("div", { key: '1c03cd18acb86c289cc55bbda26060a081fa790e', class: { input__container__wrapper: !this.chips, input__container__wrapper__chips: this.chips } }, index.h("slot", { key: '4d8f23af8beb8cf3e0bb8b81a6a5f93db24bc708', name: "inside-input-left" }), index.h(Element, { key: 'afc2258f440156e78e813193dd8bf13d85e4fb6b', class: { input__container__text: true, input__container__text__chips: this.chips }, ref: (input) => (this.nativeInput = input), rows: this.rows, cols: this.cols, autocapitalize: this.autoCapitalize, autocomplete: this.autoComplete, disabled: this.disabled, min: this.min, max: this.max, minLength: this.minlength, maxLength: this.maxlength, name: this.inputName, onBlur: this.onBlur, onFocus: this.onFocus, onInput: this.onInput, placeholder: this.placeholder, readOnly: this.readonly, type: this.type, value: this.encodeValue(this.value), pattern: this.pattern, required: this.required, part: "input", "data-test": this.dataTest }))), this.counterLength && (index.h("bds-counter-text", { key: '1b7a56f5ade4bd5b4effcda745aa14ec63d5a81c', length: this.value.length, max: this.maxlength, active: isPressed, ...this.counterLengthRule })), this.success && index.h("bds-icon", { key: 'bcdf7d6d85a7948e6f18cf9f46d422349961c17b', class: "icon-success", name: "check", theme: "outline", size: "small" }), index.h("slot", { key: 'ec5a250c0a3d5bca3141a365e28a6dbac3868b0d', name: "input-right" })), this.renderMessage()));
    }
