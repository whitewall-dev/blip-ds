...
import { g as getScrollParent, p as positionAbsoluteElement } from './position-element-060a6274.js';
...
const SelectChips = class {
    ...
    render() {
        ...
        return (h("div", { key: '0c7d83fe556161e74a5a195210beed706ed388d9', class: "select", tabindex: "0", onFocus: this.setFocusWrapper, onBlur: this.removeFocusWrapper }, h("div", { key: '760b54d041c00383347d0295a51ad1b428d24076', class: { element_input: true }, "aria-disabled": this.disabled ? 'true' : null, onClick: this.toggle }, h("div", { key: '7d46bc3a2eb35e08cf7cdd4dc8a867f833f883b4', class: {
                input: true,
            ...
            }, onClick: this.onClickWrapper }, this.renderIcon(), h("div", { key: '95a894a11a4d14b301a0d22cc4a69bbfb0b9b549', class: "input__container" }, this.renderLabel(), h("div", { key: '05440fc98d044221f20ae71254b251fd2d965d0d', class: { input__container__wrapper: true } }, this.internalChips.length > 0 && (h("span", { key: '7e5668e323ff4711ff0ce3d9d768a8107edbbcd6', style: { height: this.height, maxHeight: this.maxHeight }, class: "inside-input-left" }, this.renderChips())), h("input", { key: 'af666e03084c213f6e8e57bc342f0e7f3b8d1707', ref: (input) => (this.nativeInput = input), class: { input__container__text: true }, name: this.inputName, maxlength: this.maxlength, placeholder: this.placeholder, onInput: this.onInput, onFocus: this.onFocus, onBlur: () => this.handleOnBlur(), onChange: () => this.handleChange, value: this.value, disabled: this.disabled, "data-test": this.dataTest, onKeyDown: this.keyPressWrapper }))), h("div", { key: 'cc70e0c956f95790e40dd8a5c14333687dcf6886', class: "select__icon" }, h("bds-icon", { key: 'a638e77198572e567b7f0e64bc47b1ca62544d53', ref: (el) => this.refIconDrop(el), size: "small", color: "inherit" })), this.success && h("bds-icon", { key: 'e22f44a71d8e2edda2f8f6d88939ca12868c40f7', class: "icon-success", name: "check", theme: "outline", size: "xxx-small" })), this.renderMessage()), h("div", { key: '74378056158ef8f84c60ef2e02eb50ab59afb8f2', ref: (el) => this.refDropdown(el), class: {
                select__options: true,
                'select__options--open': this.isOpen,
            } }, internalOptions.map((option) => (h("bds-select-option", { key: this.generateKey(option.value), onOptionSelected: this.handler, value: option.value, status: option.status }, option.label))), h("slot", { key: 'fbee6ee7564d5fe4e44d7710fcc825557b8f900c' }), this.canAddNew === true && this.enableCreateOption() && (h("bds-select-option", { key: '7d67f0e43ed95b3b0bf1e7deabe542fa268c6302', id: "option-add", value: "add", onClick: () => this.handlerNewOption(this.nativeInput.value) }, this.newPrefix, this.nativeInput.value)), !this.canAddNew && this.enableCreateOption() && (h("bds-select-option", { key: '78f2802c69fa75de96d1f6a6eb5b68dd2c2d4bb0', id: "no-option", value: "add" }, this.notFoundMessage)))));
    }
