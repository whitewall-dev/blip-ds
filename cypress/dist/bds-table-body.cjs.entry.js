...
const BdsTableBodyStyle0 = tableBodyCss;
...
const TableBody = class {
    ...
    render() {
        return (index.h(index.Host, { key: '5724bda9bbf3c1bad1b85894f5c7a98e7e0a243e', class: { host: true, multiple: this.multipleRows } }, index.h("slot", { key: '25e0ef39db787b10aa53dddfbe2dbacbfb77aab6' })));
    }
    get element() { return index.getElement(this); }
};
TableBody.style = BdsTableBodyStyle0;
