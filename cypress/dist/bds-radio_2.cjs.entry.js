...
const Radio = class {
    ...
    render() {
        return (index.h(index.Host, { key: '353354f7ddb2632b6b30ac79b776704e992427b3' }, index.h("label", { key: '7075b6c6acade09b8395b4990cb8d5f902555f33', class: "radio", htmlFor: this.radioId }, index.h("input", { key: 'f92487ebd9d39482dce12e546260a02096e50161', class: "radio__input", type: "radio", ref: this.refNativeInput, id: this.radioId, onClick: this.onClick, disabled: this.disabled, checked: this.checked, value: this.value, name: this.name, "data-test": this.dataTest }), index.h("div", { key: 'd0a04ea3ce9e89fedf0240aa0d6513bcc4352be7', class: "radio__circle" }, !this.disabled ? index.h("div", { class: "focus", tabindex: "0", onKeyDown: this.handleClickKey.bind(this) }) : '', !this.disabled ? index.h("div", { class: "hover" }) : '', index.h("div", { key: 'f81aaf2d3ac703ac72362c7f2ca0c1c7848c7c56', class: "radio__circle__pointer" })), this.label && (index.h("bds-typo", { key: '0726bbd801121f2fd6f7cef0a76f2108f008fab3', class: "radio__text", variant: "fs-14", bold: this.checked ? 'bold' : 'regular', tag: "span" }, this.label)), index.h("slot", { key: 'd418059153bc630e81ffc9be1589c1417c7ad584' }))));
    }
    static get watchers() { return {
        "checked": ["checkedChanged"]
    }; }
};
Radio.style = BdsRadioStyle0;
...
const BdsSwitchStyle0 = switchCss;
