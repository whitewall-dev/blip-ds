...
const BdsButtonStyle0 = buttonCss;
...
const Button = class {
    ...
    render() {
        return (index.h(index.Host, { key: '0ec0883776d547b7606ba43ce642fef060b718f3', class: { host: true, block: this.block, group: this.group } }, index.h("div", { key: 'fc7baa9f0ee9d599351ebfb640d669e754a4d755', tabindex: "0", onKeyDown: (ev) => this.handleClick(ev), class: "focus" }), index.h("button", { key: 'a1144fcd0a954735d2f60f575a1c1f7c3f783d1c', onClick: (ev) => this.handleClick(ev), disabled: this.disabled, tabindex: "-1", "aria-disabled": this.disabled ? 'true' : 'false', "aria-live": "assertive", type: this.type, class: {
                button: true,
            ...
            }, part: "button", "data-test": this.dataTest }, this.bdsLoading ? this.renderLoadingSpinner() : '', this.iconLeft || this.icon ? (index.h("bds-icon", { class: { icon_buttom: true, hide: this.bdsLoading }, name: this.icon ? this.icon : this.iconLeft, theme: this.iconTheme, type: this.typeIcon, color: "inherit", size: 'medium' })) : (''), index.h("bds-typo", { key: '5a9cb6ddfd8f04363ea8ae8e78f622975ea29b64', class: { typo_buttom: true, button__content: true, hide: this.bdsLoading }, variant: "fs-14", lineHeight: "simple", bold: "bold" }, index.h("slot", { key: '0cc0379e33a1b12344a7c8eca15e7dcb24f6fe81' })), this.iconRight || this.arrow ? (index.h("bds-icon", { class: { icon_buttom: true, hide: this.bdsLoading }, name: this.arrow ? 'arrow-right' : this.iconRight, color: "inherit", theme: this.iconTheme, type: this.typeIcon })) : (''))));
    }
