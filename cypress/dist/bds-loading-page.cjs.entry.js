...
const BdsLoadingPageStyle0 = loadingPageCss;
...
const BdsLoading = class {
    ...
    render() {
        return (index.h(index.Host, { key: '8c72eb87438b0aa1e3cbc85e385003d47e64696b' }, index.h("div", { key: '15cde81733178c69e71700c1b0a6605fabef4cea', class: "loading-container", "data-test": this.dataTest }, index.h("div", { key: '7408863a818344eca4dd0c51be265e225d94d953', class: { page_loading: true }, innerHTML: this.svgContent }))));
    }
};
BdsLoading.style = BdsLoadingPageStyle0;
