...
const BdsCarousel = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '74ee81b2d1f44c9b3608e29406e84e37c1051e2f', class: { carousel: true } }, index.h("div", { key: '43cf9ff3e4d9c268db9d49890f9249e5b5a63b05', class: {
                carousel_slide: true,
                carousel_slide_fullwidth: this.arrows != 'outside',
                [`carousel_slide_state_${this.autoplayState}`]: this.autoplay,
            }, tabindex: "0", onKeyDown: (ev) => this.setKeydownNavigation(ev), "data-test": this.dtSlideContent }, index.h("div", { key: 'fe28e7e41187fff8b66a7317ae27ca3d3d3b9031', ref: (el) => this.refFrame(el), class: { carousel_slide_frame: true, carousel_slide_frame_loading: this.loading }, onMouseOver: () => this.onMouseOver(), onMouseOut: () => this.onMouseOut(), onMouseDown: (ev) => this.onMouseDown(ev), onMouseEnter: () => this.onMouseEnter(), onMouseUp: () => this.onMouseUp(), onMouseMove: (ev) => this.onMouseMove(ev) }, index.h("div", { key: '089b768cc2fa235c44528f9be60663f44a8c60e6', ref: (el) => this.refFrameRepeater(el), class: { carousel_slide_frame_repeater: true } }, index.h("slot", { key: '37d8eb5909b28f5739031b2ab7b11213ed5b0a27' }))), index.h("bds-grid", { key: '587e5313e7632f25c859d777c95cc2f0082d69ea', class: { carousel_slide_loading: true, carousel_slide_loading_visible: this.loading } }, index.h("bds-skeleton", { key: 'da81fcfb2c72551b9db18fd919897a95f8f17f34', height: "100%", shape: "square", width: "100%" })), this.arrows != 'none' && !this.loading && (index.h(ThemeOrDivArrows, { key: 'dd76853e90246ec9c77f99054b87dcfa913f6c8e', ref: (el) => this.refThemeProviderArrows(el), class: {
                carousel_buttons: true,
                carousel_buttons_fullwidth: this.arrows != 'outside',
            } }, index.h("bds-button", { key: '43fe28c26b04e41b076f57233f14bcd838428492', variant: "text", iconLeft: "arrow-left", color: "content", onBdsClick: () => this.prevSlide(), disabled: !this.infiniteLoop && this.itemActivated <= 1, dataTest: this.dtButtonPrev }), index.h("bds-button", { key: '9441f8b13a9d6d4cfca05b7cf8a2fe3763746d78', variant: "text", iconLeft: "arrow-right", color: "content", onBdsClick: () => this.nextSlide(), disabled: !this.infiniteLoop && this.itemActivated >= this.internalItens.length, dataTest: this.dtButtonNext })))), this.internalItens.length > 1 && this.bullets != 'none' && (index.h("div", { key: 'c7c99634dbb49407dc1dc3b30f8868f526e529c4', class: {
            ...
            } }))))))))))), index.h("slot", { key: 'fd1bf1befa93988403ab716ef15af0b3acc51e99', name: "after" })));
    }
