...
const Table = class {
    ...
    render() {
        return (index.h(index.Host, { key: '364082094ee5475fd0e04a19e2d4949cfaaff5bb', class: { scrollable: this.scrollable, 'dense-table': this.denseTable } }, index.h("div", { key: '0a1897205bac89066474c78855873546324395e5', class: "bds-table" }, index.h("slot", { key: '201d08c50a54a44641e595184eb7a15c7acd714e' }))));
    }
};
