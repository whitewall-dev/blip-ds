...
const Tabs = class {
    ...
    render() {
        return (h(Host, { key: 'f47392a388565ff8f64de7129210d5371224131a', class: {
                'bds-tabs': true,
                [`bds-tabs--${this.align}`]: true,
            } }, h("div", { key: '1a0dd025d55b0f354474b1d76fc280b777650a9c', class: "bds-tabs__header-button-container" }, h("bds-button-icon", { key: 'c497eef23508ccb748859013381cdb4b02cf1b56', class: "bds-tabs__header-button", icon: "arrow-left", size: "short", id: "bds-tabs-button-left", onClick: () => this.handleScrollButtonClick("left" /* ScrollDirection.LEFT */), variant: "secondary" })), h("div", { key: 'fbab7f38a456325a4ccc5d14351ef6c7150c32f8', class: "bds-tabs__header" }, h("slot", { key: '5e0b241cf593a3197ae333143794d298b9712fc4' })), h("div", { key: '2d28b1bc5b681db1ed7c3c79b26324b47792dcc7', class: "bds-tabs__header-button-container" }, h("bds-button-icon", { key: '64d8c2f878b1554ff81cd23a23d21b3c5c6d7aac', class: "bds-tabs__header-button", icon: "arrow-right", size: "short", id: "bds-tabs-button-right", onClick: () => this.handleScrollButtonClick("right" /* ScrollDirection.RIGHT */), variant: "secondary" }))));
    }
    get el() { return getElement(this); }
};
Tabs.style = BdsTabsStyle0;
