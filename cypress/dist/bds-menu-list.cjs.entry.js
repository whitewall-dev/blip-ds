...
const BdsMenuListStyle0 = menuListCss;
...
const MenuList = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'e3f3ca0b83df2ef5b9960cd8d05a1be49bef79d0' }, index.h("div", { key: 'b443864afd4531f931d2d2b52bda07dc9eaa7971', class: "menu-list" }, index.h("div", { key: '53a7c52513bb2b3f8ea94db5653874130ee4226a', class: "menu-list__left" }), index.h("slot", { key: '3f71c5b4ffb945f4097c834fe3da2fff76ba8f0b' }), index.h("div", { key: '98cff431f9af96c3b4bdb5461d1b0a70fd7c76e3', class: "menu-list__right" }))));
    }
};
MenuList.style = BdsMenuListStyle0;
