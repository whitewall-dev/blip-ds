...
const BdsTabGroup = class {
    ...
    render() {
        ...
        return (h(Host, { key: '9158c3360a871b8daa1e983a035a9665b8a99c5b' }, h("div", { key: 'cabc1c0d65ee4d37e096a70c62214ca30cf8f7a2', class: { tab_group: true } }, this.isSlideTabs && this.alignTab != 'left' && (h("bds-button-icon", { key: '9defae696b94a2546eadfb15fc7d759f041282ec', class: "tab_group__slide-button", icon: "arrow-left", size: "short", id: "bds-tabs-button-left", onClick: () => this.prevSlide(), dataTest: this.dtButtonPrev, variant: "secondary" })), h("div", { key: 'e98fbd7c1b3ae240663066b661282beb530250b1', class: { tab_group__header: true, tab_group__slide: this.isSlideTabs }, ref: this.refHeaderElement }, h("div", { key: '184bc4c4c1ce3a60dbc58ce60e1f34f08ca16741', class: {
            ...
            this.internalItens.map((item, index) => {
                ...
                return (h("div", { class: {
                    ...
                    ? this.renderBadge(item.badgeShape, item.badgeColor, item.badgeIcon, item.badgeAnimation, item.badgeNumber)
                    : ''));
            }))), this.isSlideTabs && this.alignTab != 'right' && (h("bds-button-icon", { key: '15908a0c1527d3e9fcf481ab453250f297bc742e', class: "tab_group__slide-button", icon: "arrow-right", size: "short", id: "bds-tabs-button-right", onClick: () => this.nextSlide(), dataTest: this.dtButtonNext, variant: "secondary" })), h("div", { key: '6814fa299133fb39062b7b2977bbdc2ea0a5da6f', class: { tab_group__content: true, tab_group__scrolled: this.contentScrollable } }, h("slot", { key: '9c90ef934f54b0f4d7b687a9fedbf7da1b4799a4' })))));
    }
    get element() { return getElement(this); }
};
BdsTabGroup.style = BdsTabGroupStyle0;
