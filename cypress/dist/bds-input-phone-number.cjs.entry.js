...
const InputPhoneNumber = class {
    ...
    render() {
        ...
        const flagsNames = Object.keys(this.countries);
        return (index.h(index.Host, { key: '6590fbca669b05fa9ba8ea35675b07618c44fefa', "aria-disabled": this.disabled ? 'true' : null }, index.h("div", { key: 'f9e1714231f59e31278813bff6c5850784a29e6b', class: { element_input: true }, "aria-disabled": this.disabled ? 'true' : null }, index.h("div", { key: 'f5e91485ef92537a8532e4c734129f9c92bea804', class: {
                input: true,
            ...
            }, onClick: this.onClickWrapper, onKeyDown: this.keyPressWrapper, part: "input-container" }, this.renderIcon(), index.h("div", { key: 'bd878801b1520708354e73d4368e808f87ed296c', onClick: this.toggle, onKeyDown: this.handleKeyDown.bind(this), "data-test": this.dtSelectFlag, class: "input__icon", tabindex: "0" }, index.h("bds-icon", { key: '7574bfee3be215bde95aff67990d76f8b16dfcae', size: "medium", theme: "solid", name: this.selectedCountry, color: "primary" }), index.h("bds-icon", { key: 'badb8eb31ea50e3da72e21cb07da98d850789670', size: "x-small", name: iconArrow })), index.h("div", { key: 'e94fa781b9e80e535d312b62778eb314f5d1d6ea', class: "input__container" }, this.renderLabel(), index.h("div", { key: '77d1f33fd7971023d9aae7af950293ea33ac0f74', class: { input__container__wrapper: true } }, index.h("div", { key: '700ae5999249ae0bd117021f8aca7f446163a530', class: "input__container__country-code" }, index.h("bds-typo", { key: 'a419890701e37ba855f6d41e5b5a8b44592a0159', "no-wrap": "true", variant: "fs-14" }, this.value)), index.h("input", { key: 'd38d1a3b6b1552b6faa1d0679a8d482842a3cc97', class: { input__container__text: true }, type: "phonenumber", required: this.required, pattern: "^(\\(?\\+?[0-9]*\\)?)?[0-9_\\- \\(\\)]*$", ref: this.refNativeInput, onInput: this.changedInputValue, onFocus: this.onFocus, onBlur: this.onBlur, value: this.text, disabled: this.disabled, "data-test": this.dataTest, maxlength: this.value === '+55' ? 25 : null }))), this.success && index.h("bds-icon", { key: 'ea49928a32c032b22b98a7a9b2699a53fcc8bf56', class: "icon-success", name: "check", theme: "outline", size: "xxx-small" }), index.h("slot", { key: 'b35e2b12b0df0efbe5b29aae04df0eccaaf61cba', name: "input-right" })), this.renderMessage()), index.h("div", { key: '2171b8047fcbc3670c9d02e4f84157b4458fc297', class: {
