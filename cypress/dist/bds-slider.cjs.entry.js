...
const BdsSliderStyle0 = sliderCss;
...
const Slider = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'ae31ea8de876fcc18c4867704eb7abde5c2223b6' }, index.h("input", { key: 'c142c89b907b69c93c502808a38764ecc535207b', ref: this.refInputSlide, type: "range", class: {
                input_slide: true,
            }, value: this.value, onInput: this.onInputSlide, onMouseEnter: this.onInputMouseEnter, onMouseLeave: this.onInputMouseLeave, "data-test": this.dataTest }), index.h("div", { key: '97afa722d84147af629c40eb76ec549758f2d475', class: "track-bg" }, index.h("div", { key: 'f6ed6ba32bcc2d04b9c9b4ef7655f0bf8b05d09a', class: { [`progress-bar`]: true, [`progress-bar-liner`]: this.type !== 'no-linear' }, ref: this.refProgressBar }, index.h("bds-tooltip", { key: 'ba0ce9cee88ec9a2d197dbfce33df47369bbb22b', ref: this.refBdsTooltip, class: { [`progress-bar-tooltip`]: true }, position: "top-center", "tooltip-text": this.inputValue }, index.h("div", { key: '47622c67ecfe674159c9a3223bdec3c23e8a3bfc', class: { [`progress-bar-thumb`]: true } }))), this.markers &&
