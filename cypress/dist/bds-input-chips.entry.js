...
const InputChips = class {
    ...
    render() {
        ...
        return (h(Host, { key: '9ef262444560c0e1b6b72fa1df7226381dfdc658', "aria-disabled": this.disabled ? 'true' : null }, h("div", { key: '16f31f7b97e6dcad9112ff4fd4159ce5cb70aeb7', class: {
                input: true,
            ...
            }, onClick: this.onClickWrapper, onKeyDown: this.keyPressWrapper, part: "input-container" }, this.renderIcon(), h("div", { key: '4e6faeb086bdf60a11c552a342d304d54fa071e0', class: "input__container" }, this.renderLabel(), h("div", { key: 'a230483bdddf124e32e5f1b37ba4969c4696a1c7', class: { input__container__wrapper: true } }, this.internalChips.length > 0 && (h("span", { key: 'da5a3a34bdf116f19f669452e39cc1011cf48f0a', style: { height: this.height, maxHeight: this.maxHeight }, class: "inside-input-left" }, this.renderChips())), this.inputAvalible && (h("input", { key: '50221fc7215b74b0f5e08eb72ecd98c1a46ba2bf', ref: (input) => (this.nativeInput = input), class: { input__container__text: true }, name: this.inputName, maxlength: this.maxlength, placeholder: this.placeholder, onInput: this.onInput, onFocus: this.onFocus, onBlur: () => this.handleOnBlur(), onChange: () => this.handleChange, value: this.value, disabled: this.disabled, "data-test": this.dataTest })))), this.counterLength && (h("bds-counter-text", { key: '1f00006a6721fe7ab906637147e712a3ef06b2a4', length: this.internalChips.length, max: this.maxChipsLength, active: isPressed })), this.success && h("bds-icon", { key: '5c11fafa555f83e3646b24b62c2e55867bb7d3ea', class: "icon-success", name: "checkb", theme: "outline", size: "xxx-small" }), h("slot", { key: 'fe60599d25c95a2bd0206cf7f265b6622b7241d8', name: "input-right" })), this.renderMessage()));
    }
...
InputChips.style = BdsInputChipsStyle0;
