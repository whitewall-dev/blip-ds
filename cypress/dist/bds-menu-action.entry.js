import { r as registerInstance, h, g as getElement } from './index-4a97732a.js';
...
const BdsMenuAction = class {
    ...
    render() {
        ...
        return (h("div", { key: '3fdcbdf2087831ca67b34460d06b2cd6a37054ad', class: {
                menuaction: true,
                [`position-${this.positionSubMenu}`]: true,
            }, onMouseOver: openSubmenu, onMouseOut: closeSubmenu }, h("button", { key: 'c52f82497fb3ab2707ee6d1d77221aa1fb96ae66', class: {
            ...
            } }, this.iconLeft && h("bds-icon", { key: '3e5fd737acf66de82bf7e4426ab32cde32e495b1', class: "icon-item", name: this.iconLeft, theme: "outline", size: "small" }), h("div", { key: '1abde5863f5f8ff855b768ee58fbf17dde9549be', class: "content-item" }, this.buttonText && (h("bds-typo", { key: '8bbe5ef19c28d3c4fa8d3c6adc7e0940f621b92a', class: "title-item", variant: "fs-16", tag: "span" }, this.buttonText)), this.subtitle && (h("bds-typo", { key: '5aff04e22f4e385ee434ee98a1f129fd493adaea', class: "subtitle-item", variant: "fs-10", tag: "span" }, this.subtitle)), this.description && (h("bds-typo", { key: '11af8b3b818e503fed7f59a450a673f280dc8066', class: "description-item", variant: "fs-10", tag: "span" }, this.description))), this.subMenu && (h("bds-icon", { key: '2207cbab6d5037c6f3ffc4f9d390d8a08179bb19', class: { arrow: true }, name: `arrow-${this.positionSubMenu}`, theme: "outline", size: "small" }))), this.subMenu && (h("div", { key: '0888c366527f7807c6ee692a43d13536820f4681', class: {
                menuaction__submenu: true,
                menuaction__submenu__open: this.delaySubMenu,
            }, style: zIndexSubmenu }, h("slot", { key: '718ec07530e383a843f3cdec6c95af3ea9594c46' })))));
    }
