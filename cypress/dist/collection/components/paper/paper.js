...
export class Paper {
    ...
    render() {
        return (h(Host, { key: 'c7a220d46811bed7dad57a90bb2beae47d41e4a5', class: {
                [`paper__elevation--${this.elevation}`]: this.hasBorder,
                border: this.border,
                [`bg-${this.bgColor}`]: true,
                [`border-${this.borderColor}`]: true,
            }, style: { height: `${this.height}`, width: `${this.width}` } }, h("div", { key: '36fd6f1c09a85bfb512062eb6d02b4c4c3a06d88', class: "paper__display", "data-test": this.dataTest }, h("slot", { key: '91b0a441266fb599e20d3d594063801125ca4c53' }))));
    }
