...
const Select = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '395a5903bdee87b520966dabdbbfdbfee17ad15c', class: "select" }, index.h("div", { key: '9e91f094e70ab8f6356e7c42a16849dcde09f9ef', class: { element_input: true }, "aria-disabled": this.disabled ? 'true' : null }, index.h("div", { key: 'e379990eb8e76609c7dd5518d5f2305676d6977e', class: {
                input: true,
            ...
            }, onClick: this.onClickWrapper, part: "input-container" }, this.renderIcon(), index.h("div", { key: '4d2ab99b1a86a0c11d8d4bc981b2f1ced58b0407', class: "input__container" }, this.renderLabel(), index.h("div", { key: '19fbd9537e2c655a6a651cf28cf2cbad0361e7a5', class: { input__container__wrapper: true } }, index.h("input", { key: 'e96ec984d2a66b5d0868216d23fa8d276c757929', ref: this.refNativeInput, class: { input__container__text: true }, onFocus: this.onFocus, onBlur: this.onBlur, value: this.text, disabled: this.disabled, placeholder: this.placeholder, readonly: true, "data-test": this.dataTest, onKeyDown: this.keyPressWrapper.bind(this) }))), index.h("div", { key: 'e7efafc535a6bc274dcc0afa3065544f4add4f18', class: "select__icon" }, index.h("bds-icon", { key: '195eabb9ebe0ac07690af9bb51b6181e05da6470', ref: (el) => this.refIconDrop(el), size: "small", color: "inherit" })), this.success && index.h("bds-icon", { key: '460be08ea568d55fc404cc84564de1c4c9507235', class: "icon-success", name: "check", theme: "outline", size: "xxx-small" })), this.renderMessage()), index.h("div", { key: '485f6fd4ae0481b6b7cb52b04201c913fa51915f', ref: (el) => this.refDropdown(el), class: {
